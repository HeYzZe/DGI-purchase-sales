<template>
    ...
    <div slot="header">
      <el-form inline :model="queryForm">
        <el-form-item label="企业名称：">
          <el-input v-model="queryForm.psName" clearable placeholder="请输入企业名称" style="width: 200px"></el-input>
        </el-form-item>
        <el-form-item>
  ...
  <!-- 评价标准列表 -->
    ...
    <el-button type="danger" @click="onDeleteItem" class="mar-t-xs">
    ...
    <el-table
      ...
      <el-table-column align="center" label="操作" width="100">
        <template slot-scope="{ row }">
          <el-button type="primary" title="编辑" @click="onClickEdit(row.rowGuid)">
      ...
      <el-table-column property="contactMan" label="联系方式"></el-table-column>
      <el-table-column property="industrialPark" label="所在区域"></el-table-column>
